...
export const base_url = import.meta.env.NODE_ENV === 'production' ? import.meta.env.VITE_BASE_URL_PROD  || "http://localhost:8000"
...
export function ChatBox(text, isUser, sender, key) {
